...

{
  ...
  "revision_reason": "Korean summary, up to 10 sentences, explaining why the analyst changed or justified EPS estimates and/or target price, or null",
  "estimates": [
    {
...
- revision_reason should summarize the analyst's stated reasoning for EPS or target-price changes in Korean
- revision_reason may be up to 10 sentences, but should be shorter if the report gives only one or two concrete reasons
- Base revision_reason only on reasoning stated in the report; do not invent explanations
